...
export const setVector3f = (out: MutableVector3f, x: number, y: number, z: number): MutableVector3f => {
  out.x = x
  out.y = y
  out.z = z
  return out
...
export const addVector3f = (a: Vector3f, b: Vector3f, out: MutableVector3f = createVector3f()): MutableVector3f =>
  setVector3f(out, a.x + b.x, a.y + b.y, a.z + b.z)

export const subtractVector3f = (a: Vector3f, b: Vector3f, out: MutableVector3f = createVector3f()): MutableVector3f =>
  setVector3f(out, a.x - b.x, a.y - b.y, a.z - b.z)
...
export const combineVector3f = (
  ...
  setVector3f(out, a.x * scaleA + b.x * scaleB, a.y * scaleA + b.y * scaleB, a.z * scaleA + b.z * scaleB)
...
export const normalizeVector3f = (vector: Vector3f, out: MutableVector3f = createVector3f()): MutableVector3f => {
...
export const crossVector3f = (a: Vector3f, b: Vector3f, out: MutableVector3f = createVector3f()): MutableVector3f =>
  setVector3f(out, a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x)
...
export const equalsVector3f = (a: Vector3f, b: Vector3f): boolean => a.x === b.x && a.y === b.y && a.z === b.z

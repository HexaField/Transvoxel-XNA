...
export const vector3iFromArray = ([x, y, z]: [number, number, number]): MutableVector3i =>
  createVector3i(x, y, z);

export const setVector3i = (
  out: MutableVector3i,
  x: number,
  y: number,
  z: number
...
export const equalsVector3i = (a: Vector3i, b: Vector3i): boolean =>
